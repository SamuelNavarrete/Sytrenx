...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md">
        <center><img src="../../Resoruce/Assets/Logo.jpg" alt="Logo" width="200" height="200">
        </center>
      </div>
    </div>
    <br>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <center><img src="../../Resoruce/Assets/liquido.jpg" class="d-block w-45" alt="..." width="200" height="200"></center>
            </div>
            <div class="carousel-item">
              <center><img src="../../Resoruce/Assets/solido.jpg" class="d-block w-45" alt="..." width="200" height="200"></center>
            </div>
            <div class="carousel-item">
              <center><img src="../../Resoruce/Assets/molienda.jpg" class="d-block w-45" alt="..." width="200" height="200"></center>
            </div>
          </div>
    ...
    <footer><div class="row" style="background-color: rgba(128, 128, 128, 0.178);">
      ...
      <div class="col-md-2"><br>
        <center><img src="../../Resoruce/Assets/doc.jpg" alt="Logo" width="50" height="50">
      </div>
      <div class="col-md-2"><br>
        <center><img src="../../Resoruce/Assets/doc.jpg" alt="Logo" width="50" height="50">
      </div>
